        ...
        return (
          <div key={el.id}>
            ...
            <p className="Details">
              ...
              Price : {el.price} <br />
              Property type : {el.property_type}<br />
              Review Score : {el.review_scores_rating}<br />
            </p>
            ...
            <p className="hosts">
              {el.host_name}<br />
              {el.host_since}<br />
              {el.host_response_time}<br />
            </p>
            <p className="financials">
                Price : {el.price}<br />
                Cleaning Fee : {el.cleaning_fee}<br />
                Cancellation Policy : {el.cancellation_policy}<br />
            </p>
